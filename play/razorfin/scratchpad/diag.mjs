...
const root='/Users/lucille/greenguard-usa-web', port=47698;
...
console.log(JSON.stringify(await p.evaluate(()=>({
  hasRF: !!window.RF, keys: window.RF?Object.keys(window.RF):null,
  hasGame: !!window.RF?.Game, gameKeys: window.RF?.Game?Object.keys(window.RF.Game):null,
  ctx: !!window.RF?.Game?.ctx,
  canvases: [...document.querySelectorAll('canvas')].map(c=>({w:c.width,h:c.height,cls:c.className,id:c.id})),
