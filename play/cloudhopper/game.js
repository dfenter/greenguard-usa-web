...
function createParticleSystems() {
  ...
  const particleVertex = 'attribute float aSize; attribute float aAlpha; varying float vAlpha; void main(){vAlpha=aAlpha;vec4 mvPosition=modelViewMatrix*vec4(position,1.0);gl_PointSize=aSize*(260.0/max(1.0,-mvPosition.z));gl_Position=projectionMatrix*mvPosition;}';
  ...
  trailPoints = new THREE.Points(trailGeometry, new THREE.ShaderMaterial({ uniforms: { color: { value: new THREE.Color(0xffd177) } }, vertexShader: particleVertex, fragmentShader: particleFragment, transparent: true, depthWrite: false }));
  ...
  burstPoints = new THREE.Points(burstGeometry, new THREE.ShaderMaterial({ uniforms: { color: { value: new THREE.Color(0x83e5c0) } }, vertexShader: particleVertex, fragmentShader: particleFragment, transparent: true, depthWrite: false }));
  ...
  windPoints = new THREE.Points(windGeometry, new THREE.ShaderMaterial({ uniforms: { color: { value: new THREE.Color(0xd9f4e9) } }, vertexShader: particleVertex, fragmentShader: particleFragment, transparent: true, depthWrite: false }));
