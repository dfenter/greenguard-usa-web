...
const VERSION = '2026-08-13-aaa1-2026-08-17-webkit-encoding-fix';
const CACHE = 'gg-' + SLUG + '-' + VERSION;
const ASSETS = [
  '/play/kinetic-burst/',
  '/play/kinetic-burst/index.html',
  '/play/kinetic-burst/manifest.json',
  '/play/kinetic-burst/sw.js',
  '/play/kinetic-burst/favicon.png',
  '/play/kinetic-burst/icon.png',
  '/play/kinetic-burst/icon512.png',
  '/play/kinetic-burst/js/content.js',
  '/play/kinetic-burst/js/sim.js',
  '/play/kinetic-burst/js/art.js',
  '/play/kinetic-burst/js/fx.js',
  '/play/kinetic-burst/js/ui.js',
  '/play/kinetic-burst/js/play.js',
  '/play/kinetic-burst/js/main.js',
  '/play/kinetic-burst/assets/cascade.mp3',
  '/play/kinetic-burst/assets/charge_full.mp3',
  '/play/kinetic-burst/assets/clash_hit.mp3',
  '/play/kinetic-burst/assets/crit.mp3',
  '/play/kinetic-burst/assets/defeat.mp3',
  '/play/kinetic-burst/assets/down.mp3',
  '/play/kinetic-burst/assets/heal.mp3',
  '/play/kinetic-burst/assets/hurt.mp3',
  '/play/kinetic-burst/assets/invalid.mp3',
  '/play/kinetic-burst/assets/link.mp3',
  '/play/kinetic-burst/assets/pop.mp3',
  '/play/kinetic-burst/assets/strike.mp3',
  '/play/kinetic-burst/assets/super.mp3',
  '/play/kinetic-burst/assets/theme_core.mp3',
  '/play/kinetic-burst/assets/theme_road.mp3',
  '/play/kinetic-burst/assets/trace_open.mp3',
  '/play/kinetic-burst/assets/ui_click.mp3',
  '/play/kinetic-burst/assets/unlock.mp3',
  '/play/kinetic-burst/assets/victory.mp3',
  '/play/kinetic-burst/assets/wave.mp3',
