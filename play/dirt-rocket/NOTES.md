...
- Before ratio: 1.50x for the main GGRacer canvas from the shared engine cap. The title HUD was capped at 1.50x.
...
- Recipe: native Three renderer density and a 3x title HUD. No factor cap beyond GGKit's required maximum of 3.
