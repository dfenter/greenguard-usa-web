(function () {
  ...
  // M1 (2026-09-17): weapons are now owned by hm2_weapons.js, loaded
  // before this file. WEAPONS/WEAPON_BY_KEY stay exported under the same
  // names so game.js keeps working unmodified for existing lookups.
  var HM2W = window.HM2_WEAPONS || { WEAPONS: [], EVOLUTIONS_BY_BASE: {}, WEAPON_MODS: [] };
  var WEAPONS = HM2W.WEAPONS.slice();
  var WEAPON_BY_KEY = {};
  ...
  var UPGRADES = [
    ...
    { key: 'weapon_lance',    icon: 'ic_lance', name: 'Lance',      max: 5, type: 'weapon', rarity: 'common', branch: 'weapon', weapon: 'lance',
      desc: function () { return 'Equip a balanced piercing bolt.'; } },
    { key: 'weapon_scatter',  icon: 'ic_pulse', name: 'Scatter',    max: 5, type: 'weapon', rarity: 'common', branch: 'weapon', weapon: 'scatter',
      desc: function () { return 'Equip a wide fan of light fragments.'; } },
    { key: 'weapon_rail',     icon: 'ic_beam',  name: 'Rail',       max: 5, type: 'weapon', rarity: 'rare', branch: 'weapon', weapon: 'rail',
      desc: function () { return 'Equip a charge-up piercing line.'; } },
    { key: 'weapon_seeker',   icon: 'ic_wisp',  name: 'Seeker',     max: 5, type: 'weapon', rarity: 'rare', branch: 'weapon', weapon: 'seeker',
      desc: function () { return 'Equip weak homing darts.'; } },
    { key: 'weapon_mortar',   icon: 'ic_pulse', name: 'Mortar',     max: 5, type: 'weapon', rarity: 'epic', branch: 'weapon', weapon: 'mortar',
      desc: function () { return 'Equip a lobbed shell with impact burst.'; } },
    { key: 'weapon_beam',     icon: 'ic_beam',  name: 'Beam',       max: 5, type: 'weapon', rarity: 'rare', branch: 'weapon', weapon: 'beam',
      desc: function () { return 'Equip a rotating piercing sweep beam.'; } },
    { key: 'weapon_glaive',   icon: 'ic_orbit', name: 'Glaive',     max: 5, type: 'weapon', rarity: 'rare', branch: 'weapon', weapon: 'glaive',
      desc: function () { return 'Equip a returning thrown blade.'; } },
    { key: 'weapon_mine',     icon: 'ic_mine',  name: 'Mine',       max: 5, type: 'weapon', rarity: 'common', branch: 'weapon', weapon: 'mine',
      desc: function () { return 'Equip stationary field charges.'; } },
    { key: 'weapon_ricochet', icon: 'ic_crit',  name: 'Ricochet',   max: 5, type: 'weapon', rarity: 'rare', branch: 'weapon', weapon: 'ricochet',
      desc: function () { return 'Equip a shard that bounces off arena edges.'; } },
    { key: 'weapon_arccoil',  icon: 'ic_crit',  name: 'Arc Coil',   max: 5, type: 'weapon', rarity: 'epic', branch: 'weapon', weapon: 'arccoil',
      desc: function () { return 'Equip a chain-lightning projectile.'; } },
    { key: 'weapon_flak',     icon: 'ic_pulse', name: 'Flak Cannon', max: 5, type: 'weapon', rarity: 'rare', branch: 'weapon', weapon: 'flak',
      desc: function () { return 'Equip proximity-fuse shrapnel bursts.'; } },
    { key: 'weapon_dronebay', icon: 'ic_wisp',  name: 'Drone Bay',  max: 5, type: 'weapon', rarity: 'epic', branch: 'weapon', weapon: 'dronebay',
      desc: function () { return 'Equip autonomous orbiting gun drones.'; } },

    { key: 'mod_rate',   icon: 'ic_speed',  name: 'Rapid Feed',       max: 6, type: 'mod', rarity: 'common', branch: 'weapon', mod: 'mod-rate',
      desc: function () { return 'Primary weapon cycles 9 percent faster.'; } },
    { key: 'mod_size',   icon: 'ic_lance',  name: 'Bulk Rounds',      max: 6, type: 'mod', rarity: 'common', branch: 'weapon', mod: 'mod-size',
      desc: function () { return 'Primary weapon hit size rises 8 percent.'; } },
    { key: 'mod_pierce', icon: 'ic_crit',   name: 'Hardened Tip',     max: 4, type: 'mod', rarity: 'rare', branch: 'weapon', mod: 'mod-pierce',
      desc: function () { return 'Primary weapon pierces one more enemy.'; } },
    { key: 'mod_crit',   icon: 'ic_damage', name: 'Fuse Overcharge',  max: 5, type: 'mod', rarity: 'rare', branch: 'weapon', mod: 'mod-crit',
      desc: function () { return 'Primary weapon gains 6 percent critical chance.'; } },
  ...
  var REGION_BOSSES = {
    'meridian-verge': { key: 'proboscis-prime', frame: 'boss', name: 'PROBOSCIS PRIME', title: 'CLASSIC HUNTER // HULL DRAIN LATCH', region: 'meridian-verge', hp: 1540, r: 72, speed: 34, dmg: 30, tint: 0x8effd8, behavior: 'latch', weaponKeys: ['lance', 'scatter', 'rail'] },
    'ember-drift': { key: 'cinder-haematarch', frame: 'boss', name: 'CINDER HAEMATARCH', title: 'EMBER TRAIL // STRIP IGNITION', region: 'ember-drift', hp: 1680, r: 76, speed: 38, dmg: 34, tint: 0xff756a, behavior: 'dive', weaponKeys: ['seeker', 'mortar', 'beam'] },
    'crystal-shoals': { key: 'glasswing-tyrant', frame: 'boss', name: 'GLASSWING TYRANT', title: 'REFRACTIVE WINGS // SHARD LARVAE', region: 'crystal-shoals', hp: 1620, r: 74, speed: 36, dmg: 31, tint: 0xa7f3ff, behavior: 'refract', weaponKeys: ['glaive', 'mine'] },
    'void-rift': { key: 'null-proboscis', frame: 'boss', name: 'NULL PROBOSCIS', title: 'BLINK STALKER // OUTRUN THE MARK', region: 'void-rift', hp: 1760, r: 73, speed: 42, dmg: 35, tint: 0xc480ff, behavior: 'blink-mark', weaponKeys: ['ricochet', 'arccoil'] },
    'aurelion-graveyard': { key: 'carrion-queen', frame: 'boss', name: 'CARRION QUEEN', title: 'HATCHERIES ACTIVE // POP THE CLUSTERS', region: 'aurelion-graveyard', hp: 1860, r: 80, speed: 30, dmg: 36, tint: 0xffb47e, behavior: 'hatchery', weaponKeys: ['flak', 'dronebay'] }
  };
  ...
  window.__HM_DATA = {
    ...
    WEAPON_MODS: HM2W.WEAPON_MODS || [],
    EVOLUTIONS_BY_BASE: HM2W.EVOLUTIONS_BY_BASE || {},
    weaponEffectiveSpec: HM2W.effectiveSpec || function (d) { return d && d.spec; },
    UPGRADES: UPGRADES,
