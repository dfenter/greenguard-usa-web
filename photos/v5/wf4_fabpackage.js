...
(3) 'pcb export pos' (CSV, mm, front side only, smd-only) -> fab_package/co2_timer_v5_CPL_SMT.csv, then post-process headers to JLCPCB column names (Designator,Val,Package,Mid X,Mid Y,Rotation,Layer);
