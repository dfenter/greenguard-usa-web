...
export default function GtmOutreachPage({ product = DEFAULT_PRODUCT, session, firstEmail, sequence, targets = [] }) {
  ...
  return (
    <GtmLayout title="Outreach" session={session} product={product}>
