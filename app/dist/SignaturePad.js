...
function SignaturePad({ onSave, onCancel, label = "Customer signature" }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { background: "#0d1a10", border: "1px solid rgba(122,171,130,0.25)", borderRadius: 10, padding: 14, color: "#d4e6ca" }, children: [
    /* @__PURE__ */ jsx("div", { style: { fontSize: "0.72rem", fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(212,230,202,0.5)", marginBottom: 8 }, children: label }),
    /* @__PURE__ */ jsx(
      "canvas",
      {
        ref: canvasRef,
    ...
    /* @__PURE__ */ jsx("p", { style: { fontSize: "0.7rem", color: "rgba(212,230,202,0.4)", margin: "8px 0 12px" }, children: "Sign with finger or stylus to acknowledge service was completed." }),
