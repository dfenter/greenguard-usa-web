...
export const CATALOG = {
  'biogents-co2-trap':     { name: 'Biogents BG-Mosquitaire CO₂ Trap',  price: 279.99,  shipping: 9.99, inStock: true  },
  'all-in-one-bundle':     { name: 'All-in-One Starter Bundle',         price: 549.99,  shipping: 30,   inStock: true  },
  'mosqitter-grand':       { name: 'Mosqitter Grand CO₂ Trap',          price: 1849.99, shipping: 170,  inStock: true  },
  'biogents-non-co2-trap': { name: 'BG-Mosquitaire (No CO₂)',           price: 179.99,  shipping: 9.99, inStock: true  },
  'biogents-co2-timer':    { name: 'Biogents CO₂ Tank Timer',           price: 89.99,   shipping: 9.99, inStock: false },
  'co2-tank-20lb':         { name: 'CO₂ Tank (20 lb Empty Cylinder)',   price: 199.99,  shipping: 30,   inStock: true  },
};
