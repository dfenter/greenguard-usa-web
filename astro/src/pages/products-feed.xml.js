...
const products = [
  ...
  },
  {
    ...
    price:       '549.99',
    salePrice:   null,
    originalPrice: '649.97',
    image:       `${BASE}/images/prod-all-in-one-bundle.jpg`,
    mpn:         'BG-BUNDLE-ALL-IN-ONE',
    description: 'Complete mosquito control starter kit. Includes Biogents BG-Mosquitaire CO2 trap, CO2 tank timer, empty 20 lb CO2 tank, and BG-Sweetscent bait pack. Save $99.98 vs buying individually. Everything to start trapping mosquitoes the same day.',
  },
  {
    id:          'product-co2-tank',
