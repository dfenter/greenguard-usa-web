-- Insert or update history rows. Captures submittedBy for audit trail.
-- Duplicate detection: same coolingTowerDataID + parameterTypesID + date = overwrite.
...
WHEN NOT MATCHED THEN
    ...
    VALUES (src.coolingTowerDataID, src.parameterTypesID, src.t_stamp,
            src.value, src.submittedBy);
