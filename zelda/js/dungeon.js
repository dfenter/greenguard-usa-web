...
const Dungeon = (() => {
  ...
  const L1 = {
    ...
    rooms: {
      ...
      '1,1': { room: room({ up:'o', right:'o' }, CORNERS, 'dungeon'),
               enemies: [['gel',null,5,4],['gel',null,10,5],['stalfos',null,8,7],['zol',null,6,7],['zol',null,9,7]],
      ...
      '0,1': { room: room({ right:'o' }, CORNERS, 'dungeon'),
               enemies: [['zol',null,5,4],['gel',null,10,6]],
               item: { kind: 'map', x: 8, y: 5, guarded:true } },
      '4,1': { room: room({ left:'o' }, PILLARS, 'dungeon'),
               enemies: [['zol',null,5,5],['keese',null,10,4]],
  ...
  const L2 = {
    ...
    rooms: {
      ...
      '3,1': { room: room({ up:'o', left:'o' }, CORNERS, 'dungeon2'),
               enemies: [['moblin','blue',4,4],['stalfos',null,11,4],['zol',null,6,7],['zol',null,9,7]],
      ...
      '3,0': { room: room({ down:'o' }, MOAT, 'dungeon2'),
               enemies: [['keese',null,6,3],['keese',null,9,3],['rope',null,8,7]],
               item: { kind: 'compass', x: 8, y: 5, guarded:true } },
  ...
  const L3 = {
    ...
    rooms: {
      ...
      '3,1': { room: room({ left:'o', up:'o' }, CORNERS, 'dungeon'),
               enemies: [['lynel',null,5,5],['gel',null,10,3],['gel',null,8,7],['rope',null,6,3]],
               item: { kind: 'heartcontainer', x: 8, y: 5, guarded:true } },
      '3,0': { room: room({ down:'o' }, PILLARS, 'dungeon'),
               enemies: [['stalfos',null,5,4],['stalfos',null,10,5],['rope',null,8,7]],
               item: { kind: 'rupee5', x: 8, y: 4 } },
      '0,1': { room: room({ right:'o' }, CORNERS, 'dungeon'),
               enemies: [['zol',null,5,4],['rope',null,10,6]],
               item: { kind: 'map', x: 8, y: 5, guarded:true } },
      '4,1': { room: room({ left:'o', up:'o' }, LANE, 'dungeon'),
               enemies: [['rope',null,5,4],['zol',null,10,6]],
               item: { kind: 'compass', x: 8, y: 5, guarded:true } },
      '4,0': { room: room({ down:'o' }, PILLARS, 'dungeon'),
               enemies: [['stalfos',null,6,4],['rope',null,10,6]] },
      '2,0': { room: room({ down:'l' }, [], 'dungeon'),
  ...
  const L4 = {
    ...
    rooms: {
      ...
      '3,2': { room: room({ left:'o', up:'o' }, LANE, 'dungeon2', { traps:true }),
               enemies: [['darknut',null,5,4],['keese',null,10,6],['bubble',null,8,7]],
      ...
      '1,1': { room: room({ right:'l', up:'s', left:'b' }, ['7,4,B','7,11,B'], 'dungeon2', { shutter: 'clear', miniboss:true }),
               enemies: [['darknut',null,5,4],['goriya','blue',10,4],['keese',null,8,7],['moldorm',null,6,6],['dodongo',null,10,6],['dodongo',null,11,3]],
               item: { kind: 'map', x: 8, y: 5, guarded:true } },
      '0,1': { room: room({ right:'b' }, CORNERS, 'dungeon2'),
               enemies: [['bubble',null,8,6]], item: { kind: 'compass', x: 8, y: 5, guarded:true } },
      '1,0': { room: room({ down:'s' }, [], 'dungeon2'),
               enemies: [], boss: { variant: 'gleeok', x: 11, y: 4, bossOpts: { headHp: 3, heads: 2 } },
               triforce: { x: 7, y: 3 } },
    },
  };

  // =========================================================================
  // LEVEL 5 — "THE LIZARD" · 7 rooms. Item: whistle. Boss: RED DODONGO (3 bombs).
  ...
  const L5 = {
    ...
    rooms: {
      ...
      '1,1': { room: room({ up:'o', down:'o', left:'o', right:'o' }, MOAT, 'dungeon', { shutter:'clear', miniboss:true }),
               enemies: [['wizzrobe',null,5,3],['ironknuckle',null,10,7],['wallmaster',null,8,3],['bubble',null,3,3],['moldorm',null,4,3],['dodongo',null,10,3],['dodongo',null,11,7]],
               item: { kind: 'map', x: 4, y: 4, guarded:true } },
      '0,1': { room: room({ right:'o', up:'o' }, LANE, 'dungeon'),
               enemies: [['darknut',null,5,4],['darknut',null,9,5],['gel',null,8,3]],
      ...
      '2,1': { room: room({ up:'o', left:'o' }, PILLARS, 'dungeon', { traps:true }),
               enemies: [['likelike',null,5,4],['goriya','brown',10,5],['bubble',null,8,7]],
               item: { kind: 'compass', x: 8, y: 5, guarded:true } },
  ...
  const L6 = {
    ...
    rooms: {
      ...
      '2,2': { room: room({ left:'o', up:'s' }, LANE, 'dungeon2', { shutter: 'clear' }),
               enemies: [['wizzrobe',null,5,4],['darknut',null,9,5],['keese',null,8,3],['bubble',null,6,7]],
      ...
      '1,0': { room: room({ left:'s', right:'s', down:'o' }, ['5,7,B','5,8,B'], 'dungeon2', { shutter: 'clear', dark:true, miniboss:true }),
               enemies: [['lynel',null,5,4],['ironknuckle',null,10,6],['gel',null,8,3],['moldorm',null,6,6],['dodongo',null,10,6],['dodongo',null,11,3]],
      ...
      '2,0': { room: room({ down:'o', left:'s' }, [], 'dungeon2'),
               enemies: [], boss: { variant: 'gohma', x: 7, y: 4 },
               triforce: { x: 7, y: 3 } },
    },
  };

  // =========================================================================
  // LEVEL 7 — "THE DEMON" · horned silhouette. Item: heart container. Boss: DIGDOGGER.
  ...
  const L7 = {
    ...
    rooms: {
      ...
      '2,1': { room: room({ up:'l', down:'o', left:'o', right:'o' }, PILLARS, 'dungeon'),
               enemies: [['wizzrobe',null,5,4],['lynel',null,10,6],['ironknuckle',null,8,7],['wallmaster',null,6,3]] },
      ...
      '2,0': { room: room({ down:'l', right:'s' }, [], 'dungeon', { shutter:'clear', miniboss:true }),
               enemies: [['wizzrobe',null,3,7],['wizzrobe',null,12,7],['moldorm',null,6,6],['dodongo',null,10,6],['dodongo',null,11,3]],
               item: { kind:'map', x:8, y:5, guarded:true } },
      '4,1': { room: room({ left:'o', up:'o' }, LANE, 'dungeon'),
               enemies: [['darknut',null,5,4],['bubble',null,10,6]],
               item: { kind:'magicalboomerang', x:8, y:5, guarded:true } },
      '4,0': { room: room({ down:'o' }, [], 'dungeon'),
               enemies: [], boss: { variant:'digdogger', x:8, y:4 }, triforce: { x:7, y:3 } },
      '3,2': { room: room({ up:'o' }, ['5,7,B'], 'dungeon', { goriyaGate:true }),
               enemies: [['bubble',null,8,3]],
               item: { kind:'compass', x:8, y:5, guarded:true } },
    },
  };
  ...
  const L8 = {
    ...
    rooms: {
      ...
      '2,1': { room: room({ down:'o', up:'o' }, ['4,4,W','4,5,W','4,10,W','4,11,W','6,4,W','6,5,W','6,10,W','6,11,W'], 'dungeon2', { traps:true }),
               enemies: [['ironknuckle',null,7,5],['wizzrobe',null,3,3],['wallmaster',null,8,3],['bubble',null,6,7]] },
      '2,0': { room: room({ down:'o', left:'s' }, [], 'dungeon2', { dark: true, shutter: 'clear', miniboss:true, traps:true }),
               enemies: [['darknut',null,5,4],['darknut',null,10,4],['lynel',null,8,7],['moldorm',null,6,6],['dodongo',null,10,6],['dodongo',null,11,3]],
               item: { kind: 'map', x: 8, y: 5, guarded:true } },
      ...
      '1,0': { room: room({ down:'l', right:'s' }, [], 'dungeon2'),
               enemies: [], boss: { variant: 'gleeok', x: 11, y: 4, bossOpts: { headHp: 4, heads: 4, extraFireballs: 2 } },
               triforce: { x: 7, y: 3 } },
    },
  };

  // =========================================================================
  // LEVEL 9 — "DEATH'S CROWN" · the post-triforce finale.  This level is
  // deliberately registered out-of-band: the eight Triforce dungeons remain
  // the canonical LEVELS/count set, while level(9) exposes this final gauntlet.
  //
  //                    [silver]--s--[GANON]--s--[ZELDA]
  //                       |             |
  ...
  const NAMES = {1:'EAGLE',2:'MOON',3:'MANJI',4:'SNAKE',5:'LIZARD',6:'DRAGON',7:'DEMON',8:'CROWN'};
