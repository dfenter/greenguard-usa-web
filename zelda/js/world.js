...
const World = (() => {
  const CFG = {
    ...
    '0,0': { theme:'death', overlay:['2,3,A','2,11,A','5,5,R','5,10,R','7,7,A','3,8,R'],
    ...
    '3,1': { theme:'over', overlay:['2,3,T','2,12,T','8,3,T','8,12,T','5,5,R'],
    ...
    '1,2': { theme:'over', overlay:['1,4,T','1,11,T','4,3,T','4,12,T','7,4,T','7,11,T','9,6,T','9,9,T'],
      enemies:[['moblin','brown',5,4],['moblin','brown',10,6],['octorok','red',8,8]] },
    '2,2': { theme:'over', overlay:['2,3,R','2,12,R','8,3,R','8,12,R','5,6,R','5,9,R'],
    ...
    '4,3': { theme:'over', overlay:['1,4,T','1,11,T','3,3,T','3,12,T','7,5,T','7,10,T','2,7,S'],
      ...
      cave:{ kind:'candle' } },
    '5,3': { theme:'over', overlay:['2,3,R','2,12,R','5,5,R','5,10,R','8,7,R','7,4,T'],
    ...
    '8,0': { theme:'death', overlay:['2,4,R','2,11,R','5,5,R','5,10,R','8,7,R'],
    ...
    '7,2': { theme:'over', overlay:['2,3,T','2,12,T','5,4,T','5,11,T','8,4,T','8,11,T'],
